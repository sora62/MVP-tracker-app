...
const Tracker = ({ handleSignOut }) => {
  ...
  return (
    <div className='tracker-container'>
      ...
      {userData && <small>Welcome back, {userData.username}</small>}
        ...
        <div className="search-button-container">
          ...
          <div className="search-icon" onClick={handleSearch}>
            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
              <title>Search</title>
              <path strokeWidth="45" strokeMiterlimit="10" stroke="currentColor" fill="none" d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z"></path>
              <path d="M338.29 338.29L448 448" strokeWidth="45" strokeMiterlimit="10" strokeLinecap="round" stroke="currentColor" fill="none"></path>
            </svg>
          </div>
        </div>
        <button className="shared-btn2" id="show-all-btn" onClick={handleShowAll}>
          <div className="shared-icon2"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M20 9v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V9" /><path d="M9 22V12h6v10M2 10.6L12 2l10 8.6" /></svg></div>
      ...
      {showAddModal && problemsOptions && userData && <AddModal setShow={setShowAddModal} datas={problemsOptions} userId={userData.userId} />}
