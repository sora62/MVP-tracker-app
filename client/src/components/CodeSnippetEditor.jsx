...
function CodeSnippetEditor({ codeData, setShowCode, handleSaveCode }) {
  ...
  return (
    <div className="code-editor-container">
      <div className="code-editor-header">
        ...
        <svg onClick={() => setShowCode(false)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="code-editor-close-icon">
      ...
      <button className="shared-btn" id="save-btn" type="button" onClick={() => handleSaveCode(code)}>
